...
<main class="main-container">
  ...
  <svg viewBox="0 0 205 3" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="input-group">
      <input style="font-size: 36px; width: 90%;height: 50px;" name="boardSubject" type="text" value="동아리명을 입력해 주세요.">
    </div>
  ...
  <div class="input-group">
      <textarea style="width: 90%;height: 600px;font-size: 36px;" placeholder="내용을 상세히 입력해주세요." ></textarea>
    </div>

  <a href="/club/add/preview">
