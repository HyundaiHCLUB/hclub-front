...
<main class="main-container">
    ...
    <div style="display: flex">
        <svg style="margin-left: 36px;margin-top: -20px;" width="80" height="160" viewBox="0 0 34 34" fill="none"
             xmlns="http://www.w3.org/2000/svg">
            <path d="M29.75 17C29.75 24.0416 24.0416 29.75 17 29.75C9.95837 29.75 4.25 24.0416 4.25 17C4.25 9.95837 9.95837 4.25 17 4.25C24.0416 4.25 29.75 9.95837 29.75 17Z"
                  fill="#F4B5B7"/>
            <path d="M18.9176 10.4545V25H16.7159V12.6562H16.6307L13.1506 14.929V12.8267L16.7798 10.4545H18.9176Z"
                  fill="white"/>
        </svg>
    ...
    <div style="display: flex">
        <svg style="margin-left: 36px" width="80" height="160" viewBox="0 0 34 34" fill="none"
             xmlns="http://www.w3.org/2000/svg">
            <path d="M29.75 17C29.75 24.0416 24.0416 29.75 17 29.75C9.95837 29.75 4.25 24.0416 4.25 17C4.25 9.95837 9.95837 4.25 17 4.25C24.0416 4.25 29.75 9.95837 29.75 17Z"
                  fill="#F4B5B7"/>
