    ...
    <div style="text-align: center">
        ...
        <div class="conbox con1">
            <div class="notice_bar">
                <a onclick="checkCreator(<%= request.getAttribute("clubNo") %>)" class="apply_button"
                   style="color: #FFFFFF">신청하기</a>
                <div onclick="checkAndOpenModal()">
                    <svg style="margin-top:10px;margin-right: 58px;" width="50" height="50" viewBox="0 0 24 24"
                         fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M17.2047 10.7962L19.0007 9.00019C19.546 8.45494 19.8186 8.18231 19.9644 7.88822C20.2416 7.32866 20.2416 6.67171 19.9644 6.11215C19.8186 5.81806 19.546 5.54544 19.0007 5.00019C18.4555 4.45494 18.1829 4.18231 17.8888 4.03658C17.3292 3.75929 16.6723 3.75929 16.1127 4.03658C15.8186 4.18231 15.546 4.45494 15.0007 5.00019L13.1821 6.81884C14.146 8.46944 15.5321 9.845 17.2047 10.7962ZM11.7276 8.2733L4.85713 15.1438C4.43207 15.5689 4.21954 15.7814 4.0798 16.0425C3.94007 16.3036 3.88112 16.5983 3.76323 17.1878L3.14784 20.2648C3.08131 20.5974 3.04805 20.7637 3.14266 20.8583C3.23727 20.9529 3.40357 20.9196 3.73618 20.8531L6.81316 20.2377C7.40262 20.1198 7.69734 20.0609 7.95844 19.9211C8.21954 19.7814 8.43207 19.5689 8.85713 19.1438L15.7465 12.2544C14.1249 11.2388 12.7532 9.87646 11.7276 8.2733Z"
                              fill="#222222"/>
                    </svg>
                </div>
            </div>
                    ...
                    <div class="modal-content" style="width: 900px;height: 1000px; margin-left: 44px">
                        <div class="modal-header">
                            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                ...
                                <path d="M28 22L28 34" stroke="#B31312" stroke-width="2" stroke-linecap="square"
                                      stroke-linejoin="round"/>
                                <path d="M34 28L22 28" stroke="#B31312" stroke-width="2" stroke-linecap="square"
                                      stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div class="modal-body" style="padding: 0">
                            <div class="input-group" style="margin-bottom: 10px;margin-left: 44px;">
                                <input id="noticeTitle" style="font-size: 36px; width: 90%;height: 50px;"
                                       name="noticeTitle" type="text" placeholder="제목을 입력해 주세요.">
                            </div>
                            <div class="input-group" style="margin-left: 44px;">
                                <textarea id="noticeContent" name="noticeContent"
                                          style="width: 90%;height: 700px;font-size: 36px;"
                                          placeholder="내용을 상세히 입력해주세요."></textarea>
                            </div>
                        </div>
                        <a onclick="createNotice()" data-dismiss="modal" aria-label="Close">
                            <div style="text-align: center;margin-bottom:40px;">
                                <svg width="600" height="60" viewBox="0 0 347 48" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <filter id="filter0_d_662_7594" x="0" y="0" width="347" height="48"
                                            ...
                                            <feBlend mode="normal" in2="BackgroundImageFix"
                                                     result="effect1_dropShadow_662_7594"/>
                                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_662_7594"
                                                     result="shape"/>
                                        </filter>
                                    </defs>
                                </svg>
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: none" role="document">
                <div class="modal-content" style="width: 900px;height: 1000px; margin-left: 44px">
                    ...
                    <div class="modal-body" style="padding: 0">
                        <div class="input-group" style="margin-bottom: 10px;margin-left: 44px;">
                            <div id="noticeTitles"
                                 style="font-size: 60px; width: 90%;height: 50px;font-weight:500;margin-top: 40px;"></div>
                        </div>
                        <div class="input-group" style="margin-left: 44px;">
                            <div id="noticeContents"
                                 style="width: 90%;height: 700px;font-size: 40px;margin-top:50px;"></div>
                        </div>
                    </div>
        ...
        <div class="conbox con2">
            <div onclick="checkMemberAndOpenModal()">
                <svg style="margin-top:10px; margin-bottom:10px; margin-left: 790px;" width="50" height="50"
