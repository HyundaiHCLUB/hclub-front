...
<head>
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9a9cfd814dc94ab10ad564b4959ffe28&libraries=services"></script>
</head>
...
<main class="main-container">
    ...
    <ul>
        <li style="list-style: none; text-align: center; margin-top: 40px">
            <input type="text" id="keyword" placeholder="장소를 검색해주세요."
                   style="font-size: 56px; text-align: center;width: 800px;margin-top: 40px;">
        </li>
        <li style="list-style: none; text-align: center; margin-top: 40px">
            <input type="text" id="address" disabled="disabled"
                   style="font-size: 40px; text-align: center;border:0px;width: 700px;">
        </li>
    </ul>
    <ul id="placesList"></ul>
